/****************************************************************************
 * arch/xtensa/src/esp32s2/esp32s2_touch_lowerhalf.h
 *
...
#ifndef __ARCH_XTENSA_SRC_ESP32S2_ESP32S2_TOUCH_LOWERHALF_H
#define __ARCH_XTENSA_SRC_ESP32S2_ESP32S2_TOUCH_LOWERHALF_H
...
{
  return REG_GET_FIELD(RTC_CNTL_TOUCH_CTRL1_REG, RTC_CNTL_TOUCH_MEAS_NUM);
}
                                      ...
                                      enum touch_cnt_slope_e slope)
{
  ...
  REG_SET_FIELD(rtcio_touch_reg[tp], RTCIO_TOUCH_PAD0_DAC, slope);
}
...
static inline enum touch_cnt_slope_e touch_lh_get_slope(enum touch_pad_e tp)
{
  ...
  return (enum touch_cnt_slope_e) REG_GET_FIELD(rtcio_touch_reg[tp],
                                                RTCIO_TOUCH_PAD0_DAC);
}
...
{
  REG_SET_FIELD(RTC_CNTL_TOUCH_CTRL2_REG, RTC_CNTL_TOUCH_START_FORCE, mode);
}
...
{
  REG_SET_FIELD(RTC_CNTL_TOUCH_CTRL2_REG, RTC_CNTL_TOUCH_CLKGATE_EN, enable);
}
...
{
  REG_SET_FIELD(RTC_CNTL_TOUCH_CTRL2_REG, RTC_CNTL_TOUCH_START_EN, false);
...
{
  REG_SET_FIELD(RTC_CNTL_TOUCH_CTRL2_REG, RTC_CNTL_TOUCH_START_EN, false);
  REG_SET_FIELD(RTC_CNTL_TOUCH_CTRL2_REG, RTC_CNTL_TOUCH_START_EN, true);
}
...
static inline enum touch_denoise_grade_e touch_lh_denoise_get_grade(void)
{
  return (enum touch_denoise_grade_e)
    REG_GET_FIELD(RTC_CNTL_TOUCH_SCAN_CTRL_REG, RTC_CNTL_TOUCH_DENOISE_RES);
}
...
{
  return REG_GET_FIELD(SENS_SAR_TOUCH_STATUS0_REG, SENS_TOUCH_DENOISE_DATA);
}
...
{
  return REG_GET_FIELD(RTC_CNTL_TOUCH_SLP_THRES_REG, RTC_CNTL_TOUCH_SLP_TH);
}
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_XTENSA_SRC_ESP32S2_ESP32S2_TOUCH_LOWERHALF_H */
