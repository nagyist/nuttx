...
#define ERRNO_SECOND(_, e, ...)  e

#define ERRNO_ISDEF(e)             ERRNO_ISDEF_(ERRNO_HOLDER_##e)
#define ERRNO_ISDEF_(arg1_or_junk) ERRNO_SECOND(arg1_or_junk 1, 0)

#define ERRNO_IF(e, n)             ERRNO_IF_(ERRNO_ISDEF(e), e, n)
#define ERRNO_IF_(c, e, n)         ERRNO_IF__(c, e, n)
#define ERRNO_IF__(c, e, n)        ERRNO_IF_##c(e, n)
#define ERRNO_IF_0(e, n)
#define ERRNO_IF_1(e, n)           else if (e == errcode) { return n;}
