...
{
  uintptr_t aligned_data(TC_CONTEXT_SIZE) dcx[TREVT_DEBUG_REGS];
...
static DEFINE_PER_CPU(struct tricore_debug_s, g_trevt_debugs);
#define g_trevt_debug this_cpu_var(g_trevt_debugs)
