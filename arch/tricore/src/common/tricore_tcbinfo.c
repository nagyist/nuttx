...
static const struct reginfo_s g_reginfo[] =
{
    ...
    {"psw",    4,    35,      TCB_REG_OFF(16 + REG_PSW),      140},
    {"sp",     4,    26,      TCB_REG_OFF(16 + REG_A10),      104},
    {"a11",    4,    27,      TCB_REG_OFF(16 + REG_UA11),     108},
    {"d8",     4,    8,       TCB_REG_OFF(16 + REG_D8),       32 },
    {"d9",     4,    9,       TCB_REG_OFF(16 + REG_D9),       36 },
    {"d10",    4,    10,      TCB_REG_OFF(16 + REG_D10),      40 },
    {"d11",    4,    11,      TCB_REG_OFF(16 + REG_D11),      44 },
    {"a12",    4,    28,      TCB_REG_OFF(16 + REG_A12),      112},
    {"a13",    4,    29,      TCB_REG_OFF(16 + REG_A13),      116},
    {"a14",    4,    30,      TCB_REG_OFF(16 + REG_A14),      120},
    {"a15",    4,    31,      TCB_REG_OFF(16 + REG_A15),      124},
    {"d12",    4,    12,      TCB_REG_OFF(16 + REG_D12),      48 },
    {"d13",    4,    13,      TCB_REG_OFF(16 + REG_D13),      52 },
    {"d14",    4,    14,      TCB_REG_OFF(16 + REG_D14),      56 },
    {"d15",    4,    15,      TCB_REG_OFF(16 + REG_D15),      60 },
};
