/****************************************************************************
 * arch/arm/src/stm32u5/stm32_spi.c
 *
...
#if defined(CONFIG_STM32U5_SPI1) || defined(CONFIG_STM32U5_SPI2) || \
    defined(CONFIG_STM32U5_SPI3)
...
#ifdef CONFIG_STM32U5_SPI_INTERRUPTS
#  error "Interrupt driven SPI not yet supported"
#endif

/* Can't have both interrupt driven SPI and SPI DMA */

#if defined(CONFIG_STM32U5_SPI_INTERRUPTS) && defined(CONFIG_STM32U5_SPI_DMA)
...
#  if defined(CONFIG_STM32U5_SPI1_DMA_BUFFER) && \
            CONFIG_STM32U5_SPI1_DMA_BUFFER > 0
#    define SPI1_DMABUFSIZE_ADJUSTED SPIDMA_SIZE(CONFIG_STM32U5_SPI1_DMA_BUFFER)
#    define SPI1_DMABUFSIZE_ALGN SPIDMA_BUF_ALIGN
#  endif

#  if defined(CONFIG_STM32U5_SPI2_DMA_BUFFER) && \
            CONFIG_STM32U5_SPI2_DMA_BUFFER > 0
#    define SPI2_DMABUFSIZE_ADJUSTED SPIDMA_SIZE(CONFIG_STM32U5_SPI2_DMA_BUFFER)
#    define SPI2_DMABUFSIZE_ALGN SPIDMA_BUF_ALIGN
#  endif

#  if defined(CONFIG_STM32U5_SPI3_DMA_BUFFER) && \
            CONFIG_STM32U5_SPI3_DMA_BUFFER > 0
#    define SPI3_DMABUFSIZE_ADJUSTED SPIDMA_SIZE(CONFIG_STM32U5_SPI3_DMA_BUFFER)
...
#if defined(CONFIG_STM32U5_SPI1)
#  define SPI1_KERNEL_CLOCK_FREQ STM32_PCLK2_FREQUENCY
#endif

#if defined(CONFIG_STM32U5_SPI2)
#  define SPI2_KERNEL_CLOCK_FREQ STM32_PCLK1_FREQUENCY
#endif

#if defined(CONFIG_STM32U5_SPI3)
#  define SPI3_KERNEL_CLOCK_FREQ STM32_PCLK3_FREQUENCY
#endif
...
#endif
#ifdef CONFIG_STM32U5_SPI1_COMMTYPE
  .config   = CONFIG_STM32U5_SPI1_COMMTYPE,
#else
  .config   = FULL_DUPLEX,
#endif
};
#endif /* CONFIG_STM32U5_SPI1 */
...
#  endif
  ...
  .pm_cb.prepare = spi_pm_prepare,
#endif
#ifdef CONFIG_STM32U5_SPI2_COMMTYPE
  .config   = CONFIG_STM32U5_SPI2_COMMTYPE,
#else
  .config   = FULL_DUPLEX,
#endif
};
#endif /* CONFIG_STM32U5_SPI2 */
...
#  endif
  ...
  .pm_cb.prepare = spi_pm_prepare,
#endif
#ifdef CONFIG_STM32U5_SPI3_COMMTYPE
  .config   = CONFIG_STM32U5_SPI3_COMMTYPE,
#else
  .config   = FULL_DUPLEX,
#endif
};
#endif /* CONFIG_STM32U5_SPI3 */
...
#if !defined(CONFIG_STM32U5_SPI_DMA) || defined(CONFIG_STM32U5_DMACAPABLE) || \
     defined(CONFIG_STM32U5_SPI_DMATHRESHOLD)
#if !defined(CONFIG_STM32U5_SPI_DMA)
...
#endif /* !CONFIG_STM32U5_SPI_DMA || CONFIG_STM32U5_DMACAPABLE ||
        * CONFIG_STM32U5_SPI_DMATHRESHOLD
        */
...
#ifdef CONFIG_STM32U5_SPI_DMATHRESHOLD
  /* If this is a small SPI transfer, then let spi_exchange_nodma() do the
   * work.
   */

  if (nbytes <= CONFIG_STM32U5_SPI_DMATHRESHOLD)
    {
...
#ifdef CONFIG_STM32U5_DMACAPABLE
...
#endif /* CONFIG_STM32U5_SPI1 || CONFIG_STM32U5_SPI2 || CONFIG_STM32U5_SPI3
        */
