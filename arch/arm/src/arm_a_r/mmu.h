...
#ifndef __ARCH_ARM_SRC_ARM_A_R_MMU_H
#define __ARCH_ARM_SRC_ARM_A_R_MMU_H
...
#define FSR_MASK                      0x0f /* Bits 0-3: Type of fault */
#define FSR_FAULT(fsr)                (((fsr) & FSR_MASK) | (((fsr) & 0x400) >> 6))
...
#if !defined(CONFIG_ARCH_ROMPGTABLE) && defined(PGTABLE_BASE_VADDR)
...
#endif /* __ARCH_ARM_SRC_ARM_A_R_MMU_H */
