...
static const struct esp32c3_mtd_dev_s g_esp32c3_spiflash =
{
  .mtd =
          {
            .erase  = esp32c3_erase,
...
static const struct esp32c3_mtd_dev_s g_esp32c3_spiflash_encrypt =
{
  .mtd =
          {
            .erase  = esp32c3_erase,
...
{
  struct esp32c3_mtd_dev_s *priv =
      (struct esp32c3_mtd_dev_s *)&g_esp32c3_spiflash_encrypt;
