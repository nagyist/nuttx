...
FAR char *fs_large_strdup(FAR const char *s) malloc_like;
FAR char *fs_large_strndup(FAR const char *s, size_t size) malloc_like;
...
#  define fs_large_strdup           strdup
#  define fs_large_strndup          strndup
#  define fs_large_asprintf         asprintf
...
#  define fs_heap_strdup            fs_large_strdup
#  define fs_heap_strndup           fs_large_strndup
#  define fs_heap_asprintf          fs_large_asprintf
