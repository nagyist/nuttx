...
function(dts_preprocess)
  ...
  if("${CONFIG_DTS_DYNAMIC_API_SUPPORT}" STREQUAL "y")
    ...
    string(REGEX
           REPLACE "nuttx.dts.pre.d" "nuttx_${CURRENT_BOARD_ID}.dts.pre.d"
...
function(gen_edt)
  ...
  if("${CONFIG_DTS_DYNAMIC_API_SUPPORT}" STREQUAL "y")
    string(REGEX REPLACE "nuttx.dts" "nuttx_${CURRENT_BOARD_ID}.dts"
                         new_dts_file "${DTS_FILE}")
...
function(gen_devicetree_header)
  ...
  if(BOARD_NUM EQUAL 1)
    ...
    if(NOT "${CONFIG_DTS_DYNAMIC_API_SUPPORT}" STREQUAL "y")
      return()
    endif()
  endif()
