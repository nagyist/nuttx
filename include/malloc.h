...
struct mallinfo
{
  unsigned int arena;    /* This is the total size of memory allocated
                          * for use by malloc in bytes. */
  unsigned int ordblks;  /* This is the number of free (not in use) chunks */
  unsigned int aordblks; /* This is the number of allocated (in use) chunks */
  unsigned int mxordblk; /* Size of the largest free (not in use) chunk */
  unsigned int uordblks; /* This is the total size of memory occupied by
                          * chunks handed out by malloc. */
  unsigned int fordblks; /* This is the total size of memory occupied
                          * by free (not in use) chunks. */
  unsigned int usmblks;  /* This is the largest amount of space ever
                          * allocated */
};
