...
#ifndef __INCLUDE_NUTTX_DEVICETREE_UTIL_INTERNAL_H
#define __INCLUDE_NUTTX_DEVICETREE_UTIL_INTERNAL_H
...
/* Implementation of IS_EQ(). Returns 1 if _0 and _1 are the same integer
 * from 0 to 4096, 0 otherwise.
 */
...
#endif /* __INCLUDE_NUTTX_DEVICETREE_UTIL_INTERNAL_H */
