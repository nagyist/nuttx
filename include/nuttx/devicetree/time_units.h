...
#ifndef __INCLUDE_NUTTX_DEVICETREE_TIME_UNITS_H
#define __INCLUDE_NUTTX_DEVICETREE_TIME_UNITS_H
 ...
 *
 *  Usage of this macro is limited to APIs that want to expose a timeout
 *  value that can optionally be unlimited, or "forever".
...
/** @brief System-wide macro to initialize #k_timeout_t with a number of
 * ticks converted from milliseconds.
 */
 ...
 *                 if ($round eq "ceil") {
 *                     print " * Rounds up to the next " .
 *                           "highest output unit.\n";
 *                 } elsif ($round eq "near") {
 *                     print " * Rounds to the nearest output unit.\n";
 *                 } else {
 *                     print " * Truncates to the next " .
 *                           "lowest output unit.\n";
 *                 }
 *                 print " *\n";
 ...
 *                 print " *", "/\n";
 *                 print "#define $sym(t) \\\n";
 *                 print "\tz_tmcvt_$ret32(t, Z_HZ_$from_unit, " .
 *                       "Z_HZ_$to_unit,";
...
#endif /* __INCLUDE_NUTTX_DEVICETREE_TIME_UNITS_H */
