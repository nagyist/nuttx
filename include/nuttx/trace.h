...
#  define cpufreq_trace_beginex(name) trace_beginex(NOTE_TAG_CPUFREQ, name)
#  define cpufreq_trace_endex(name) trace_endex(NOTE_TAG_CPUFREQ, name)
...
#  define cpufreq_trace_beginex(name)
