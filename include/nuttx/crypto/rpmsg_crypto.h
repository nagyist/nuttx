...
#ifndef __INCLUDE_NUTTX_CRYPTO_RPMSG_CRYPTO_H
#define __INCLUDE_NUTTX_CRYPTO_RPMSG_CRYPTO_H
...
#ifdef CONFIG_CRYPTO_RPMSG_SERVER
...
#endif /* __INCLUDE_NUTTX_CRYPTO_RPMSG_CRYPTO_H */
